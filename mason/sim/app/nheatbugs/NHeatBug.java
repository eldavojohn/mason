...
public class NHeatBug implements Steppable {
    ...
    public NHeatBug( double idealTemp, double heatOutput, double randomMovementProbability, int loc_x, int loc_y) {
    ...
    public void addHeat(final NDoubleGrid2D grid, final int x, final int y, final double heat) {
        ...
        if (new_heat > NHeatBugs.MAX_HEAT)
            new_heat = NHeatBugs.MAX_HEAT;
