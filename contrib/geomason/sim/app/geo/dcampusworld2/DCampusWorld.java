...
public class DCampusWorld extends SimState
{
    ...
    public DCampusWorld(long seed)
    {
        ...
        try
        {
            ...
            // Each agent move independently, seems neighborhood is not really playing any role here
            int[] aoi = new int[] {10, 10};
            int[] size = new int[] { (int) WIDTH, (int) HEIGHT };
            int[] discretizations = new int[] {7, 7};
            ...
            System.out.print("width and height is:" + communicator.getPixelWidth() + ", "+ communicator.getPixelHeight());
...
//        	Timing.start(Timing.MPI_SYNC_OVERHEAD);
            try {
            	// TODO
            	// this only sync the communicator,
            	// what about agent field?
